...
set.seed(123)
sample <- sample.int(n = nrow(bev.imp.missForest), size = floor( .75 * nrow(bev.imp.missForest)), replace = FALSE)
bev_train <- bev.imp.missForest[sample, ]
bev_test <- bev.imp.missForest[-sample, ]
