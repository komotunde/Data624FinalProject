...
library(readxl)
bev <- read.csv("https://raw.githubusercontent.com/komotunde/Data624FinalProject/master/StudentData_train_csv.csv",na.strings=c("","NA"))
...
library(knitr)
training.summary <- read.csv("https://raw.githubusercontent.com/komotunde/Data624FinalProject/master/StudentData_train_csv.csv",na.strings=c("","NA"))
...
ranfor.bevPred <- predict(ranfor.bev, newdata = bev.test)
